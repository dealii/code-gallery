...
namespace dealii::PolyUtils
{
   ...
   * triangulation.
   *
   * @note The given triangulation must be a
   * parallel::fullydistributed::Triangulation. This is required as the
   * partitions generated by p4est, the partitioner for
                                  ...
                                  const SparsityTools::Partitioner partitioner)
  {
    ...
    Assert((parallel_triangulation != nullptr),
           ExcMessage(
             "Only fully distributed triangulations are supported. If "
             "you are using"
             "a parallel::distributed::triangulation, you must convert "
             "it to a fully"
    ...
    const SparsityTools::Partitioner partitioner)
  {
    ...
    Assert((parallel_triangulation != nullptr),
           ExcMessage(
             "Only fully distributed triangulations are supported. If you are "
             "using"
