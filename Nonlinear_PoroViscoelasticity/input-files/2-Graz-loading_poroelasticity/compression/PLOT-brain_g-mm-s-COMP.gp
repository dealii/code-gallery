...
set style line 5  lw 1.5  lc rgb "dark-red"        dt 1
...
#area of loading surface to compute reaction force [mm²]
...
set xrange [1.0:0.89] reverse                    #compression
set yrange [0.0:5.5]
...
set output "brain_cube_stress-stretch-poro-COMP.png"
...
set output "brain_cube_solid-stress-stretch-poro-COMP.png"
plot 'data-for-gnuplot.sol' index 0 using (stretch($7)):(nominal($21)) every 1  with lines ls 1 title '1^{st} cycle', \
     'data-for-gnuplot.sol' index 1 using (stretch($7)):(nominal($21)) every 1  with lines ls 2 title '2^{nd} cycle', \
     'data-for-gnuplot.sol' index 2 using (stretch($7)):(nominal($21)) every 1  with lines ls 3 title '3^{rd} cycle'
...
set output "brain_cube_fluid-time-poro-COMP.png"
...
set output "brain_cube_fluid-reac_p-poro-COMP.png"
...
set y2tics autofreq
set key width -5
set output "brain_cube_pres-displ-vs-time-poro-COMP.png"
